...
class BDSClue:
    ...
    def clue1(self):
        ...
        self.canvas.create_text(400, 100, **self.text_style, text = "Le calcul est de la forme '_ * _ _ = _ _ _'")

    def clue2(self):
        self.clue2_button.destroy()
        self.canvas.create_text(400, 350, **self.text_style, text = "La première case est occupée par un 9")

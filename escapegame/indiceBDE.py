...
class BDEClue:
    ...
    def clue1(self):
        ...
        self.canvas.create_text(400, 100, **self.text_style, text = "Il y a du orange dans le résultat final")

    def clue2(self):
        self.clue2_button.destroy()
        self.canvas.create_text(400, 350, **self.text_style, text = "Ainsi que du violet et du bleu")
